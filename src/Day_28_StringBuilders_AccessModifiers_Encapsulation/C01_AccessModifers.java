...
public class C01_AccessModifers {
    ...
    public static void main(String[] args) {
        ...
        C01_AccessModifers C01_AccessMod = new C01_AccessModifers(); // created an object from this class to reach the non-static variable
